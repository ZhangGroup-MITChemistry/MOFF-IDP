...
if len(sys.argv)>7:
    ...
    print("python write_table.py ionic_strength outputfile cut cut2 table_length dr\n")
...
if len(sys.argv)>2:
    outputflie=sys.argv[2]
else:
    outputflie='table.xvg'
...
numpy.savetxt(outputflie,new_mat)
